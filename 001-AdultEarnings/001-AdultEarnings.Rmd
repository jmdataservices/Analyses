...
#### Residual Error Plot (Earnings Class ~ Age)

``` {r rel_age_mod_residuals, fig.width = 10}

logisticmodel_age_residuals

```

<br>

#### Residual Error Distribution (Earnings Class ~ Age)

``` {r rel_age_mod_residuals2}

logisticmodel_age_residuals2
